...
// func (uc *leaveApplicationUseCase) ApplyLeave(payload model.TransactionLeave) error {
// 	employee, err := uc.employeeRepo.Get(payload.EmployeeID)
// 	if err != nil {
// 		return err
// 	}

// 	leaveType, err := uc.leaveTypeRepo.Get(payload.LeaveTypeID)
// 	if err != nil {
// 		return err
// 	}

// 	if payload.StatusLeaveID == "" {
// 		statusLeave, err := uc.statusLeaveRepo.GetByName("Pending")
// 		if err != nil {
// 			return err
// 		}
// 		payload.StatusLeaveID = statusLeave.StatusLeaveName
// 	}
