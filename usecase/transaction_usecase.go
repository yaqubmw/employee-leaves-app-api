...
type TransactionLeaveUseCase interface {
	...
	FindAllEmpl(requesPaging dto.PaginationParam) ([]model.TransactionLeave, dto.Paging, error)
}
...
func (t *transactionLeaveUseCase) FindAllEmpl(requesPaging dto.PaginationParam) ([]model.TransactionLeave, dto.Paging, error) {
